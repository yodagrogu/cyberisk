<div x-data="{ open: false }" class="flex h-full md:flex-1">
    <div class="flex-1 hidden h-full space-x-8 md:flex">
        ...
        <!-- Adding in new header menu options -->
                ...
                <div class="border border-gray-100 shadow-md rounded-xl">
                    <div class="overflow-hidden shadow-xs rounded-xl">
                        <div class="relative z-20 grid gap-6 px-5 py-6 bg-white sm:p-8 sm:gap-8">
                            <a href="{{ route('wave.dashboard') }}" class="block px-5 py-3 -m-3 space-y-1 transition duration-150 ease-in-out hover:border-blue-500 hover:border-l-2 rounded-xl hover:bg-gray-100">
                                <p class="text-base font-medium leading-6 text-gray-900">
                                    Security Controls Table
                                </p>
                                <p class="text-xs leading-5 text-gray-500">
                                    View your security controls.
                                </p>
                            </a>
                            <a href="{{ route('wave.reporting') }}" target="_blank" class="block px-5 py-3 -m-3 space-y-1 transition duration-150 ease-in-out rounded-xl hover:bg-gray-100">
                                <p class="text-base font-medium leading-6 text-gray-900">
                                    Reporting
                                </p>
                                <p class="text-xs leading-5 text-gray-500">
                                    View your control posture.
                                </p>
                            </a>
                        </div>
                    </div>
